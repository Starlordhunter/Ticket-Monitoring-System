    ...
    <body onload="realtimeClock()">
                            ...
                            <div class="card-body dd-flex align-items-center">
                                ...
                                <div class="icon-info-text">
                                    ...
                                    <ul>
                                        <li>
                                            <strong>Closed</strong>
                                            <span>{{$closetickets_aadk}}</span>
                                        </li>
                                        <li>
                                            <strong>Total</strong>
                                            <span>{{$totaltickets_aadk}}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="tab-pane fade show active" id="all-time" role="tabpanel" aria-labelledby="all-time-tab">
                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                            <?php 
                            $i= 1;?>
                            @foreach($agent_aadk as $agentdata)
        ...
        google.charts.setOnLoadCallback(drawChart);
            ...
            function drawChart() {
                ...
                model_data.addRows([
                    @foreach($model_aadk as $model_data)
                ...
                loc_data.addRows([
                    @foreach($lokasi_aadk as $loc_data)
